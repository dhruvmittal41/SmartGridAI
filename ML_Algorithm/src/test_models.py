...
lstm_model = tf.keras.models.load_model(
    "../models/lstm_autoencoder.keras", compile=False
)
...
mock_data = {
    "x_Timestamp": pd.date_range(
        start="2020-01-01 00:00:00", periods=num_samples, freq="h"
    ),
    "t_kWh": energies,
    "Voltage": voltages,
    "Current": currents,
...
features = df[
    ["voltage", "current", "frequency", "energy_kwh", "power", "rolling_energy"]
]
...
print(df[["timestamp", "voltage", "frequency", "energy_kwh", "prediction"]].head(20))
